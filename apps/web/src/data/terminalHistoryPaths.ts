...
import { terminalHistoryUnitedNationsPath } from "./terminalHistoryUnitedNationsPath";
...
export const terminalHistoryPaths = [
  terminalHistoryUnitedNationsPath,
  ...historyCourses.map(createHumanitiesPath),
];
