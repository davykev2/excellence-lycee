...
> **Méthode BAC.** Construis chaque paragraphe avec **fait daté → bénéficiaire → résultat → limite → condition d’amélioration**.` ,
  ...
  "terminale-hg-h1-united-nations": {
    splitSectionIndex: 2,
    memorySentence: "1941-1945 : construire l’ONU ; ensuite, relier buts, organes, résultats, limites et réformes.",
    mission: {
      title: "L’ONU a-t-elle rempli sa mission ?",
      scenario: "À l’occasion du 74e anniversaire de l’ONU, un officiel soutient que l’organisation est née du rapport de forces de 1945, ne reflète plus entièrement le monde actuel et présente un bilan mitigé. Il faut identifier le problème, expliquer le poids des vainqueurs de la guerre et prendre position à l’aide du cours.",
      modelAnswer: "L’ONU a construit un cadre universel de coopération, des normes de droits humains et des instruments de paix et d’aide. Elle reste toutefois limitée par le veto, la représentation héritée de 1945, les rivalités, les mandats et les moyens. Sa disparition aggraverait le manque de coopération : une réforme argumentée est plus justifiée.",
      bodyMarkdown: String.raw`## Trois situations du document à mobiliser

### 1. Le bilan de l’organisation

La situation d’évaluation de la page 9 insiste sur deux idées : le Conseil de sécurité conserve la marque des vainqueurs de 1945 et le bilan doit être qualifié de **mitigé**, avec des acquis et des défis.

### 2. Les crises africaines et les intérêts des puissances

La page 11 évoque Rwanda, Centrafrique, Congo, Liberia, Darfour, Libye et Côte d’Ivoire. La consigne ne demande pas d’accuser une puissance unique : il faut expliquer comment intérêts stratégiques, veto, sélectivité des décisions, mandats et coopération des parties peuvent limiter l’action, puis montrer pourquoi **réformer** est plus défendable que supprimer l’ONU.

### 3. Le discours d’Emmanuel Macron, 21 septembre 2020

Le président français rappelle une « triple promesse » : préserver les générations futures de la guerre, affirmer les droits et l’égalité des nations, favoriser le progrès social. Il décrit ensuite une « maison commune » dont les fondations s’érodent. Le point de vue est donc double : **fidélité aux buts** et **fragilité institutionnelle**.

## Deux documents critiques à contextualiser

- **Ignacio Ramonet, octobre 1992** : au début de l’après-guerre froide, il réclame un Conseil plus représentatif et critique la domination des puissances. Boutros Boutros-Ghali est alors secrétaire général ; l’affirmation selon laquelle les vetos auraient pris fin est un jugement daté que l’histoire ultérieure dément.
- **Richard Falk, février 1991** : il critique le mandat très large donné par la résolution 678 pour la guerre du Golfe et craint que l’ONU ne devienne un instrument de la politique américaine.

> **Méthode BAC.** Pour expliquer un passage : 1) reformule son sens ; 2) donne le mécanisme historique ; 3) apporte un exemple ; 4) reviens à la consigne. Pour prendre position : annonce « je partage / je ne partage pas », avance deux arguments, ajoute une nuance puis conclus.`,
      questions: [
        { prompt: "De quel problème parle l’officiel ?", options: ["Du bilan, de l’efficacité et de la représentativité de l’ONU", "De la production agricole mondiale", "Du climat ivoirien", "De la création de l’Union européenne"], correctIndex: 0, explanation: "La situation confronte les missions de l’ONU à ses résultats et à sa structure héritée de 1945.", sourceLabel: "Situation d’évaluation, p. 9 — consigne 1", points: 1 },
        { prompt: "Pourquoi l’ONU est-elle présentée comme née de la volonté des vainqueurs de la Seconde Guerre mondiale ?", options: ["Parce que seuls les vainqueurs siègent à l’Assemblée", "Parce que les principales puissances victorieuses ont façonné la Charte et obtenu un siège permanent avec veto", "Parce que la SDN a signé la Charte", "Parce que les agences humanitaires dirigent le Conseil"], correctIndex: 1, explanation: "La composition permanente du Conseil traduit le rapport de forces de 1945.", sourceLabel: "Situation d’évaluation, p. 9 — consigne 2", points: 2 },
        { prompt: "Peut-on partager l’idée que le bilan de l’ONU est mitigé ?", options: ["Non, car l’ONU n’a que des succès", "Non, car l’ONU n’a jamais agi", "Oui : elle a des acquis réels mais aussi des limites institutionnelles et opérationnelles", "Oui, donc elle doit disparaître"], correctIndex: 2, explanation: "Une réponse argumentée cite au moins un acquis, une limite et une réforme.", sourceLabel: "Situation d’évaluation, p. 9 — consigne 3", points: 2 },
      ],
      extraQuestions: [
        { prompt: "Quel problème principal soulève la situation des crises africaines ?", options: ["Les limites de l’ONU face aux crises répétées et aux intérêts des puissances", "Le nombre de juges de la CIJ", "La date de l’UPU", "La production de cacao"], correctIndex: 0, explanation: "La situation interroge l’efficacité de l’organisation dans les crises africaines.", sourceLabel: "Situation d’évaluation 1, p. 11 — consigne 1", points: 1 },
        { prompt: "Comment expliquer le « jeu d’intérêt des grandes puissances » ?", options: ["Les puissances n’ont aucune influence", "Leurs intérêts géopolitiques peuvent orienter, sélectionner ou bloquer certaines décisions", "Toutes les crises sont créées par la CIJ", "L’Assemblée dispose d’un veto par État"], correctIndex: 1, explanation: "Le rapport de forces, le veto et les alliances influencent la capacité d’action collective.", sourceLabel: "Situation d’évaluation 1, p. 11 — consigne 2", points: 2 },
        { prompt: "L’ONU devrait-elle disparaître parce qu’elle a montré ses limites ?", options: ["Oui, toute limite impose une disparition", "Oui, car la coopération est inutile", "Non : ses fonctions restent essentielles et ses limites justifient des réformes", "Non, car elle n’a aucune limite"], correctIndex: 2, explanation: "Supprimer le cadre collectif ne résout ni les conflits ni les rivalités ; la position la plus argumentée défend la réforme.", sourceLabel: "Situation d’évaluation 1, p. 11 — consigne 3", points: 2 },
        { prompt: "De quoi est-il question dans les extraits du discours de Macron ?", options: ["De la fidélité de l’ONU à ses buts et de la fragilisation de l’organisation", "De la création de la CEDEAO", "Du climat coréen", "Du fonctionnement du FMI seul"], correctIndex: 0, explanation: "Le discours associe la triple promesse de 1945 à l’érosion de la maison commune.", sourceLabel: "Situation d’évaluation 2, pp. 11-12 — consigne 1", points: 1 },
        { prompt: "Que signifie l’image des fondations qui s’érodent et des murs qui se lézardent ?", options: ["Le siège de New York est physiquement détruit", "Les principes et mécanismes de coopération sont affaiblis, parfois par les grandes puissances fondatrices", "Les agences changent de logo", "Les États quittent tous l’Assemblée"], correctIndex: 1, explanation: "La maison commune symbolise l’ordre multilatéral et ses institutions.", sourceLabel: "Situation d’évaluation 2, pp. 11-12 — consigne 2", points: 2 },
        { prompt: "L’ONU est-elle restée fidèle à ses objectifs de paix, de droits et de progrès social ?", options: ["Oui sans aucune réserve", "Non, elle n’a produit aucun texte", "Partiellement : elle a obtenu des résultats mais reste en deçà de ses promesses", "Non, ces objectifs n’existent pas dans la Charte"], correctIndex: 2, explanation: "La réponse doit confronter des réalisations précises à des échecs et contraintes.", sourceLabel: "Situation d’évaluation 2, pp. 11-12 — consigne 3", points: 2 },
        { prompt: "Pourquoi faut-il dater le texte de Ramonet ?", options: ["Parce qu’il exprime un débat de 1992 au début de l’après-guerre froide", "Parce qu’il s’agit d’une résolution de 1945", "Parce qu’il décrit la composition de 2026", "Parce qu’il est un arrêt de la CIJ"], correctIndex: 0, explanation: "Ses prévisions et jugements doivent être replacés dans leur contexte.", sourceLabel: "Documentation, pp. 12-13 — Ramonet, 1992" },
        { prompt: "L’affirmation « les vetos ont pris fin » après la guerre froide est-elle devenue un fait durable ?", options: ["Oui, le veto a été supprimé en 1992", "Non : les permanents ont continué à utiliser le veto", "Oui, l’Assemblée l’a interdit", "Non, car le Conseil n’a jamais eu de veto"], correctIndex: 1, explanation: "Le document exprime un espoir ou un constat conjoncturel qui ne résiste pas à l’histoire ultérieure.", sourceLabel: "Documentation, pp. 12-13 — Ramonet, 1992", points: 2 },
        { prompt: "Quelle inquiétude Richard Falk exprime-t-il à propos de la résolution 678 ?", options: ["Un mandat trop large pourrait transformer l’ONU en instrument de la politique américaine", "La résolution interdit tout usage de la force", "La CNUCED dirige la guerre", "Le Conseil de tutelle contrôle l’Irak"], correctIndex: 0, explanation: "Falk critique le blanc-seing perçu pour la guerre du Golfe.", sourceLabel: "Documentation, p. 13 — Falk, 1991", points: 2 },
        { prompt: "Quelle méthode permet de confronter Ramonet et Falk au cours ?", options: ["Réciter leurs phrases comme des faits actuels", "Ignorer leur auteur et leur date", "Distinguer faits, interprétations et contexte, puis vérifier l’évolution ultérieure", "Choisir le texte le plus long"], correctIndex: 2, explanation: "L’étude documentaire exige attribution, contextualisation et confrontation aux connaissances.", sourceLabel: "Documentation, pp. 12-13 — méthode", points: 2 },
      ],
    },
  },
