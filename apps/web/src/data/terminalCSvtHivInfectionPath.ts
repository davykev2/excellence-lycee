...
const sourceDocument = "SVT Tle C_L6_Linfection de lorganisme par le VIH.pdf";
...
> **Correction de classement :** la couverture interne porte « Leçon 11 ». Dans le catalogue de Terminale C transmis pour la plateforme, ce document occupe la **leçon 6**. Le contenu scientifique, lui, reste celui du document.
...
`,
    ...
    questions: [
      ...
      choice("Quelle différence est correcte ?", ["Le SIDA est un virus différent", "VIH et SIDA sont deux bactéries", "Tout porteur du VIH est immédiatement au stade SIDA", "Le VIH est le virus ; le SIDA est un stade avancé de l’infection"], 3, "Le stade SIDA n’est pas synonyme de toute infection par le VIH."),
    ...
    corrections: [
      "La couverture interne « Leçon 11 » est alignée sur la leçon 6 du catalogue Terminale C fourni à la plateforme.",
...
`,
  ...
  {
    id: "reverse-transcription-integration",
...
`,
  ...
  {
    id: "acute-infection-seroconversion",
...
Chez un adulte, être **séropositif** signifie qu’une infection par le VIH a été mise en évidence selon l’algorithme diagnostique approprié. Cela ne renseigne pas, à lui seul, sur le stade clinique. Le nombre de T CD4, la charge virale, les symptômes et les maladies associées sont évalués séparément.
...
`,
    ...
    questions: [
      ...
      choice("Quel indicateur sert directement à suivre l’efficacité virologique d’un traitement ?", ["La charge virale", "La taille", "Le groupe Rhésus", "Le nombre de dents"], 0, "La suppression de la charge virale est un objectif majeur du traitement."),
...
Le **SIDA** est le stade le plus avancé de l’infection. Dans les classifications courantes, il est défini notamment par un nombre de T CD4 inférieur à environ **200 cellules par millimètre cube** ou par la présence de certaines affections définissant le SIDA. Une seule sérologie positive ne suffit donc pas à conclure que ce stade est atteint.
...
`,
  ...
  {
    id: "transmission-prevention-treatment",
...
| PrEP | avant et pendant une période d’exposition possible | antirétroviraux pris par une personne séronégative selon un protocole médical |
| PEP | après une exposition potentielle | traitement d’urgence commencé le plus vite possible, idéalement en 24 h et au plus tard en 72 h |
| prise en charge périnatale | grossesse, naissance, allaitement | traitement et suivi pour réduire fortement la transmission à l’enfant |

Une exposition récente nécessite une orientation rapide vers un service de santé. L’élève ne doit pas s’automédiquer ni attendre l’apparition de symptômes.

## 3. Le traitement change la vie et la transmission

Le **traitement antirétroviral** associe des médicaments qui bloquent plusieurs étapes du cycle. Il ne retire pas tous les provirus, mais il peut abaisser durablement la charge virale jusqu’à un niveau indétectable, permettre au système immunitaire de se restaurer et éviter la progression vers le SIDA.
...
`,
    ...
    questions: [
      ...
      choice("Quel est l’effet principal du traitement antirétroviral ?", ["Éliminer instantanément tout provirus", "Transformer le virus en bactérie", "Bloquer fortement la réplication et restaurer l’immunité", "Créer le groupe sanguin"], 2, "Le traitement contrôle le virus sans supprimer immédiatement tous les réservoirs."),
    ...
    corrections: [
      ...
      "La PEP est précisée : le plus tôt possible, idéalement dans les 24 heures et au plus tard dans les 72 heures.",
  ...
  {
    id: "official-sequence-gap-exercises",
...
`,
  ...
  {
    id: "mother-child-diagnosis-final-mission",
...
| E1 à la naissance | positif | 0 | anticorps détectés mais aucune virémie détectée à cette mesure |
| M2, mère de E2 | positif | $10^4$ | mère vivant avec le VIH |
| E2 à la naissance | positif | $5 \\times 10^2$ | matériel viral détecté à la mesure |
...
Chez un enfant de moins de 18 mois exposé pendant la période périnatale, le diagnostic repose sur des tests **virologiques** qui détectent directement l’ARN ou l’ADN du VIH. Un résultat positif doit être confirmé selon le protocole médical ; l’exercice utilise une mesure unique pour faire raisonner.

## 3. Lire les deux courbes d’anticorps

### Enfant E1

Le taux d’anticorps est élevé à la naissance puis diminue régulièrement jusqu’à devenir presque nul. Cette évolution correspond à la disparition progressive des IgG maternelles, sans production durable propre à l’enfant. Avec une charge virale nulle dans le tableau, les données de l’exercice conduisent à conclure que **E1 n’est pas infecté**.

### Enfant E2

Le taux d’anticorps baisse d’abord : les IgG maternelles disparaissent. Il remonte ensuite : l’enfant produit ses propres anticorps en réponse à une infection persistante. La charge virale de $5 \\times 10^2$ renforce cette conclusion. Dans le cadre de l’exercice, **E2 est infecté par le VIH**.
...
3. **déduire** : E1 non infecté selon les données, E2 infecté, tout en rappelant la confirmation virologique en situation réelle.
...
`,
    keyPoint: "Chez le nouveau-né, les anticorps maternels rendent l’ELISA non conclusif : E1 perd ces anticorps sans virémie, tandis que E2 présente une virémie et une production propre d’anticorps.",
    example: "E1 : ELISA positif mais charge virale nulle, puis anticorps en diminution continue. On attribue la sérologie initiale aux IgG maternelles et on conclut, dans l’exercice, à l’absence d’infection.",
    methodSteps: [
      ...
      "Déduis l’état de chaque enfant et ajoute la règle moderne de confirmation virologique.",
    ],
    interaction: {
      kind: "curve",
    ...
    questions: [
      ...
      choice("Quelle conclusion correspond à E1 dans le cadre de l’exercice ?", ["SIDA déclaré", "Infection prouvée par ELISA seul", "Aucune conclusion possible malgré toutes les données", "Non infecté selon la charge nulle et la disparition des anticorps maternels"], 3, "Les données convergent vers l’absence d’infection de E1."),
      ...
      choice("Quelle conclusion correspond à E2 dans l’exercice ?", ["Non exposé", "Simple transfert d’anticorps sans virus", "Infecté, car la virémie est détectable et ses anticorps remontent", "Guéri sans traitement"], 2, "Les deux indices convergent vers une infection."),
      short("Donne l’état de E1 attendu par l’exercice.", ["non infecté", "non infecte", "pas infecté", "pas infecte", "séronégatif après disparition des anticorps maternels", "seronegatif"], "E1 est considéré comme non infecté d’après les données."),
      short("Donne l’état de E2 attendu par l’exercice.", ["infecté", "infecte", "infectée", "infectee", "infecté par le VIH", "porteur du VIH", "vit avec le VIH"], "E2 est considéré comme infecté par le VIH."),
    ],
    corrections: [
      ...
      "E1 est décrit comme non infecté selon les données, plutôt que « sain », qui dépasserait la question du VIH.",
...
export const terminalCSvtHivInfectionPath: LearningPath = {
  id: "terminale-c-svt-l6-hiv-infection",
  subjectId: "svt",
