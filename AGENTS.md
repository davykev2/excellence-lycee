...
1. Appliquer le même traitement d'enrichissement aux **leçons 05 à 08 de Terminale A** (PDF sources dans `C:\Users\krouk\Downloads\Documents\COURS\TA\Maths TA\`). Elles sont aujourd'hui bien plus légères que les leçons 01 à 04 : environ 200 lignes chacune dans `terminalAMathFaithfulCoursePaths.ts`. Les 19 leçons de Terminale C et les 12 de Terminale D sont dans le même cas (générateur compact).
