...
1. Appliquer le même traitement d'enrichissement à la **leçon 08 de Terminale A** (dernière restante) (PDF sources dans `C:\Users\krouk\Downloads\Documents\COURS\TA\Maths TA\`). Elle reste aujourd'hui bien plus légère que les leçons déjà reprises. En Terminale C, les leçons 01 et 02 sont désormais enrichies ; les leçons 03 à 19 et les 12 leçons de Terminale D utilisent encore le générateur compact.
1b. **Appliquer à la base de production Supabase les migrations `20260723180000_terminal_a_statistics_mission.sql` et `20260723200000_terminal_a_linear_systems_missions.sql`** (le déploiement Vercel ne les exécute pas). La migration `20260723160000` des Suites a, elle, été appliquée et vérifiée le 23/07/2026.
