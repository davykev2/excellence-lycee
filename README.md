...
- La page Admin comporte une **vue d’ensemble éditoriale** qui mesure en direct la couverture du catalogue : parcours publiés, niveaux enrichis par matière et par série, questions et XP, avec recherche et filtres par niveau, matière et état (complet, partiel, à enrichir). La couverture est calculée depuis le contenu réel de l’application, sans saisie manuelle.
