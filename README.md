...
- L’épreuve transversale **« Concours BAC & BT 2024 »** est intégrée dans l’Arène : les 69 QCM tiennent sur une page, la copie devient immuable après validation, la note est calculée sur 69 avec appréciation, et l’administrateur contrôle séparément l’ouverture du sujet et l’accès aux résultats/corrections détaillées. Le résultat distingue Anglais `/20`, Culture générale `/25`, Culture scientifique `/24` et Total `/69`. Admin → Opérations dispose aussi d’un tableau privé de toutes les copies avec élève, classe, date, sous-notes, total et appréciation, ainsi que d’un export PDF classé de tous les participants, sans exposer les réponses ni le corrigé.
- La bibliothèque **Exos type BAC** propose aussi les sessions 2017, 2018, 2019 et 2020 issues du document d’archives fourni. Chaque sujet conserve ses pages d’origine, possède une feuille-réponse numérique adaptée à son nombre de questions et impose le choix de la zone du candidat. Les quatre sujets sont fermés par défaut et peuvent être activés ou désactivés séparément depuis Admin → Opérations, sans modifier l’état du concours 2024.
...
- La leçon 09 de SVT de Terminale C **« La mise en place des gisements pétrolifères en Côte d’Ivoire »** est publiée en neuf niveaux et 95 réponses évaluables : bassin sédimentaire ivoirien, fonctions des roches, dépôt organique et kérogène, maturation thermique, migrations primaire et secondaire, classement gaz–pétrole–eau, pièges et trois exercices officiels. Trois coupes SVG, trois cartes et trois chronologies originales remplacent les scans. La carte historique, l’affirmation d’une zone de Grand-Bassam exclusivement gazière, les rôles roche mère/réservoir/couverture, la légende fautive des pièges, la double négation de l’exercice 1 et les produits des puits A/B sont corrigés ou explicités. Le parcours distribue exactement 10 000 XP.
- La leçon 10 de SVT de Terminale C **« L’exploitation des gisements pétrolifères »** est publiée en neuf niveaux et 90 réponses évaluables à partir des habiletés et consignes du guide officiel DPFC : prospection et niveaux de preuve, sismique-réflexion, interprétation, forage sécurisé, récupérations primaire et assistée, traitement gaz-pétrole-eau, impacts et mission de décision offshore. Neuf interactions sont originales. Le parcours distingue cible sismique et gisement prouvé, levage et injection, FPSO et raffinerie, bénéfices potentiels et résultats gouvernés ; il distribue exactement 10 000 XP. Sa source est explicitement qualifiée d’**adaptation pédagogique** tant qu’aucun PDF complet de cette leçon n’est fourni.
- La leçon 11 de SVT de Terminale C **« L’amélioration de la fertilité du sol »** clôt le catalogue C avec neuf niveaux, 90 réponses et neuf interactions originales. Adaptée des pages 9 et 18 du programme-guide DPFC, elle traite diagnostic, eau et air, rotations, grade N-P₂O₅-K₂O, amendements calcaire et humifère, lixiviation, pollution et interprétation d’un essai témoin/calcaire/compost. Elle distribue 10 000 XP et ne présente aucune donnée créée comme un résultat officiel.
- Les leçons 8 et 9 de SVT de Terminale D sont désormais enrichies et distribuent chacune 10 000 XP. **« La transmission d’un caractère héréditaire chez l’Homme »** compte dix niveaux, 100 réponses et dix interactions adaptés du guide DPFC. **« La transmission de deux caractères héréditaires chez les êtres vivants »** compte onze niveaux, 110 réponses et onze interactions : son support complet de 19 pages est restitué et corrigé, puis complété — avec la fidélité `adapted` clairement séparée — par le pourcentage de liaison, l’hybridation, le clonage, l’insémination artificielle et la FIVETE exigés par le guide. Le numéro interne L12 reste distingué de la place 9 dans le catalogue. Le compteur public consolidé atteint **9 719 réponses évaluables**.
...
- La leçon 03 de Terminale A **« Fonction logarithme népérien »** est enrichie sur le même modèle : huit niveaux fidèles au cours officiel, résolutions d’équations et d’inéquations entièrement rédigées, mission finale du dépistage de la fièvre typhoïde et défi type Bac. Le moteur de courbes sait désormais tracer les fonctions logarithmiques : la courbe de ln et celle du défi type Bac sont manipulables au curseur.
- La leçon 13 de Terminale C **« Nombres complexes et géométrie du plan »** est enrichie en dix niveaux fidèles : 108 questions issues du cours et de ses exercices, trois schémas interactifs, une mission finale sur quatre triangles rectangles isocèles et les corrections explicites des coquilles de la source. Ses identifiants et son barème historique restent inchangés ; la version Terminale D correspondante bénéficie automatiquement du même enrichissement.
- La leçon 14 de Terminale C **« Isométries du plan »** est enrichie en huit niveaux fidèles : les 23 pages du cours, les exercices 1 à 19, la table complète des 36 compositions du triangle équilatéral et la situation complexe du motif de pagne forment 188 réponses évaluables. Trois schémas interactifs expliquent les invariants, les deux réflexions et la symétrie glissée ; les identifiants et le barème historique restent inchangés.
- La leçon 16 de Terminale C **« Similitudes directes »** est enrichie en neuf niveaux fidèles : rapport et angle, composition, invariants, décomposition canonique, écriture complexe, détermination, constructions et applications forment 178 réponses évaluables. Quatre schémas interactifs accompagnent le cours ; les erreurs du cercle d’Apollonius, de l’ellipse, de la somme d’aires et de l’extrait Bac C 1998 sont corrigées et signalées, sans changer les identifiants ni le barème historique.
- La leçon 17 de Terminale C **« Probabilité conditionnelle et variable aléatoire »** est enrichie en huit niveaux fidèles : conditionnement, indépendance, arbres pondérés, variables aléatoires, espérance et dispersion, Bernoulli, loi binomiale et fonction de répartition forment 132 réponses évaluables. Six diagrammes et deux schémas interactifs accompagnent le cours ; l'écart type oublié, la loi d'urne inversée et les probabilités erronées des morceaux sont corrigés et signalés. Les identifiants et le barème historique restent inchangés, et la leçon 02 de Terminale D bénéficie automatiquement du même contenu partagé.
- La leçon 18 de Terminale C **« Équations différentielles »** est enrichie en six niveaux fidèles et 106 réponses évaluables : reconnaissance, premier ordre, solution particulière, conditions initiales, modélisation et second ordre sont accompagnés de cinq diagrammes et d’une courbe démographique interactive. Le seuil des 20 millions est corrigé à 2039, la condition $f(0)=-2$ est restaurée et les autres coquilles du corrigé sont signalées. Les identifiants et le barème historique restent inchangés, et la leçon 12 de Terminale D bénéficie automatiquement du même contenu partagé.
- La leçon 19 de Terminale C **« Statistique à deux variables »** est enrichie en six niveaux fidèles et 83 réponses évaluables : tableaux de contingence et séries marginales, nuage, point moyen, covariance, corrélation, régressions et estimations sont accompagnés d’un schéma, de trois diagrammes et de deux droites interactives. Les erreurs d’arrondi de la source, le calcul de l’estimation à 9 ha et la fin absente de l’exercice d’hévéa sont corrigés et signalés. Les identifiants et le barème historique restent inchangés, et la leçon 11 de Terminale D bénéficie automatiquement du même contenu partagé. **Les 19 leçons de Mathématiques de Terminale C sont désormais enrichies.**
- La leçon 15 de Terminale C **« Calcul intégral »** est enrichie en huit niveaux fidèles : définition et aire, propriétés algébriques et d’ordre, valeur moyenne, intégration par parties, changement de variable, symétries, aires et fonctions définies par une intégrale forment 153 réponses évaluables. Deux courbes et un schéma interactifs accompagnent le cours ; l’aire erronée de la terrasse et les incohérences des approfondissements sont corrigées et signalées, sans changer les identifiants ni le barème historique. La leçon 10 de Terminale D bénéficie automatiquement du même contenu partagé.
- La leçon 04 de Terminale A **« Fonction exponentielle »** est enrichie sur le même modèle : huit niveaux fidèles au cours officiel, équations et inéquations exponentielles entièrement rédigées, primitives de la série A1 et mission finale de la campagne publicitaire. Le moteur de courbes trace désormais les fonctions exponentielles : la courbe de e^x et la courbe de saturation publicitaire P(t) = 1 − e^(−0,21t) sont manipulables au curseur.
- **Les huit leçons de mathématiques de Terminale A sont désormais toutes enrichies** au même standard : cours officiel intégral rédigé, exercices corrigés pas à pas, encadrés « Erreur fréquente » et « Astuce mémoire de Davy », mission finale contextualisée et courbes interactives. La leçon 08 **« Primitives et calcul intégral »** clôt la série avec une mission où l’élève calcule l’aire d’une terrasse par intégration, puis celle de la piscine du lycée — la question qui ouvrait le cours et que le document source laissait sans réponse.
- La leçon 07 de Terminale A **« Systèmes linéaires »** est enrichie et complétée de deux missions : quatre niveaux de cours (substitution et combinaison, systèmes logarithmiques et exponentiels, demi-plans, systèmes d’inéquations), puis le **concours d’awalé** — où l’élève traduit une règle de jeu en système d’équations — et le **cocktail sous contraintes**, une véritable situation de programmation linéaire dont le domaine des possibilités est exploré au curseur.
- La leçon 06 de Terminale A **« Statistique à deux variables »** est enrichie et complétée d’un niveau : neuf niveaux de cours (séries doubles, séries marginales, nuage de points, point moyen, ajustement de Mayer, covariance, corrélation, droites de régression, estimation) plus une **mission finale** de prévision météorologique, où l’élève établit la corrélation entre pluviométrie et température puis interprète une prévision hors du domaine de validité du modèle.
- La leçon 05 de Terminale A **« Suites numériques »** est enrichie et enrichie d’un niveau supplémentaire : huit niveaux de cours (suites arithmétiques et géométriques, termes généraux, variations, sommes, tableau récapitulatif) plus une **mission finale** qui réunit trois problèmes de placement financier — l’épargne à intérêts composés de Mme Koffi, la comparaison de deux plans de carrière et le pont logarithmique entre suites géométriques et arithmétiques. Deux courbes illustrent la saturation d’une somme géométrique et l’envol d’un capital composé.
- **Toute la série d’Histoire des Terminales (leçons H2 à H9) est enrichie et en ligne** : la bipolarisation, le passage vers un monde multipolaire, la montée des nationalismes africains, l’accession à l’indépendance de la Côte d’Ivoire puis de l’Algérie, l’Union africaine, les croyances et valeurs du monde occidental et les mutations de la civilisation négro-africaine. Chaque leçon suit un même standard : cours rédigé avec tableaux et encadrés, corrections annotées des coquilles du document source, questions d’entraînement sourcées, un niveau découpé en deux et une **mission finale** bâtie sur la situation d’évaluation et ses documents. Une seule leçon d’Histoire sert les trois séries A, C et D.
- La page Admin comporte une **vue d’ensemble éditoriale** cadrée par toutes les leçons du programme : elle rattache les parcours réellement publiés au catalogue et laisse visibles les leçons encore sans contenu comme « À construire ». Les petits résumés automatiques ne suffisent plus à déclarer une leçon de Mathématiques ou de Physique-Chimie complète. La vue présente le taux honnête par matière et par série, les questions et les XP, avec recherche et filtres par niveau, matière et état.
- La leçon 05 de Physique commune aux Terminales C et D **« Oscillations mécaniques libres »** est publiée en huit niveaux et 51 questions : vocabulaire, système masse-ressort, équation différentielle, conditions initiales, graphes, conservation de l'énergie, exercices officiels et mission sur les suspensions. Les figures sont redessinées et interactives ; les erreurs de dérivation, de définition de la fréquence, de raideur et d'étiquetage du PDF source sont corrigées et signalées. Le parcours distribue exactement 10 000 XP.
- La leçon 06 de Physique commune aux Terminales C et D **« Champ magnétique »** est publiée en huit niveaux et 60 questions : interactions, vecteur champ, lignes et spectres, orientation et valeur du champ d'un solénoïde, superposition avec le champ terrestre, exercices officiels et mission expérimentale $B=f(I)$. Trois schémas SVG originaux et une courbe de mesures remplacent les figures scannées. Les erreurs du document sur $L\geq10R$, l'exercice 2, l'unité de la pente, l'arrondi par couche et les données absentes de l'exercice 5 sont corrigées et signalées. Le parcours distribue exactement 10 000 XP.
- La leçon 08 de Physique commune aux Terminales C et D **« Loi de Laplace »** est publiée en huit niveaux et 76 questions : expériences de tige et de rails, loi vectorielle, règle de la main droite, valeur selon l'angle, balance de Cotton, applications, exercices officiels et mission expérimentale $I=f(m)$. Trois schémas SVG originaux, deux cartes interactives, deux courbes et une démarche guidée remplacent les figures scannées. La valeur à $45^\circ$, l'unité des masses de la balance et la lecture de $\sin(2\alpha)$ sont corrigées ou explicitées. Le parcours distribue exactement 10 000 XP.
- La leçon 09 de Physique de Terminale C **« Induction électromagnétique »** est publiée en huit niveaux et 85 questions : flux orienté, expériences d'induction, loi de Lenz, loi de Faraday, courant et charge induits, transformateurs, alternateurs, exercices officiels, bobines couplées et signaux d'oscilloscope. Deux schémas SVG originaux, deux cartes interactives, trois courbes et une démarche guidée remplacent les figures scannées. La dérivée de l'alternateur, la terminologie de la tige mobile, le sens du courant, la dépendance du champ au rayon et l'unité du dernier graphe sont corrigés ou explicités. Le parcours distribue exactement 10 000 XP.
- La leçon 10 de Physique commune aux Terminales C et D **« Auto-induction »** est publiée en huit niveaux et 90 questions : mise en évidence et transitoires, flux propre, inductance, f.é.m., tension d'une bobine réelle, énergie magnétique, exploitation d'un courant par morceaux, exercices officiels et mission sur l'étincelle de rupture. Quatre courbes, deux cartes interactives, une démarche guidée et un calculateur d'énergie remplacent les figures scannées. Les flux, énergies et tensions incohérents du document source sont recalculés et signalés. Le parcours distribue exactement 10 000 XP.
- La leçon 11 de Physique en Terminale C et leçon 9 en Terminale D **« Montages dérivateur et intégrateur »** est publiée en huit niveaux et 86 questions : AOP idéal, reconnaissance des circuits, démonstrations entrée-sortie, quiz du dérivateur et de l'intégrateur, carte de comparaison et situation d'évaluation complète. Trois schémas SVG originaux, deux oscillogrammes interactifs, une carte de décision, une démarche guidée et un calculateur de pente remplacent les figures du PDF. La formulation du rôle de l'AOP, la constante d'intégration, le rôle des résistances pratiques et la nature impulsionnelle du dernier signal sont corrigés ou explicités. Le parcours distribue exactement 10 000 XP.
- La leçon 12 de Physique en Terminale C et leçon 10 en Terminale D **« Oscillations électriques libres dans un circuit LC »** est publiée en neuf niveaux et 110 questions : charge et décharge du condensateur, régimes d'amortissement, équation différentielle du circuit LC, pulsation et phase, conservation de l'énergie, analogie mécanique-électrique, entretien des oscillations, évaluation officielle et consolidation critique. Deux schémas SVG originaux, deux oscillogrammes interactifs, deux cartes, deux démarches guidées et un calculateur remplacent les figures du PDF. Les conventions de courant, l'intitulé d'un graphe, le seuil d'amortissement, le signe de la résistance négative et les données manquantes du dernier exercice sont corrigés ou explicités. Le parcours distribue exactement 10 000 XP.
- La leçon 13 de Physique en Terminale C et leçon 11 en Terminale D **« Circuit RLC en régime sinusoïdal forcé »** est publiée en neuf niveaux et 114 questions : signaux sinusoïdaux, impédance expérimentale, déphasage à l'oscilloscope, équation du circuit série, construction de Fresnel, nature inductive ou capacitive, situation d'évaluation et deux missions expérimentales. Quatre schémas SVG, deux cartes, une courbe de mesures, une démarche guidée et un calculateur remplacent les figures du PDF. Les signes de phase contradictoires, l'amplitude de la tension du condensateur, la résistance totale de la bobine, la mesure à l'ohmmètre, les sensibilités manquantes et la capacité finale corrigée à 8,68 µF sont explicités. Le parcours distribue exactement 10 000 XP.
- La leçon 14 de Physique en Terminale C et leçon 12 en Terminale D **« Résonance d’intensité d’un circuit RLC série »** est publiée en neuf niveaux et 127 questions : courbes expérimentales, condition de résonance, bande passante à 3 dB, facteur de qualité, sélectivité, surtension, situation d’évaluation, cinq exercices officiels et mission d’accord radio. Trois courbes interactives, deux schémas SVG, deux démarches guidées et deux calculateurs remplacent les figures du PDF. La fréquence FM est corrigée en 92,0 MHz, la capacité de l’exercice 1 en 202,6 µF, la capacité omise de l’exercice 4 en 2,49 µF et les données incompatibles de la situation d’évaluation sont démontrées au lieu d’être reproduites silencieusement. Le parcours distribue exactement 10 000 XP.
- La leçon 15 de Physique en Terminale C et leçon 13 en Terminale D **« Puissance en courant alternatif »** est publiée en neuf niveaux et 127 questions : puissance instantanée et moyenne, puissance apparente, facteur de puissance, énergie, transport sous haute tension, puissance d’un RLC selon la fréquence, bande de demi-puissance et cinq exercices officiels. Quatre courbes interactives, un schéma de réseau, une carte de grandeurs, deux démarches guidées et un calculateur remplacent les figures du PDF. La puissance maximale est rétablie à 96,8 W, les coupures à 49,18 Hz et 128,76 Hz sont remises dans l’ordre, le facteur de puissance de l’exercice 3 est corrigé à 1 et l’exercice 4 est entièrement recalculé avec une résistance optimale de 29,31 Ω. Le parcours distribue exactement 10 000 XP.
- La leçon 16 de Physique en Terminale C **« Modèle ondulatoire de la lumière »** est publiée en neuf niveaux et 127 questions : diffraction, largeur de la tache centrale, interférences de Young, différence de marche, interfrange, spectre électromagnétique, évaluation du pointeur laser, exercices officiels et mission expérimentale. Deux schémas SVG originaux, trois courbes interactives, une carte spectrale et trois démarches guidées remplacent les figures du PDF. Le thème erroné de la couverture est corrigé, la première radiation du tableau est rétablie à 420 nm, la fente du TP à 0,10 mm, le pointeur à 678,75 nm et l’angle final à 3,15×10⁻³ rad. Le parcours, propre à la Terminale C, distribue exactement 10 000 XP.
- La leçon 17 de Physique en Terminale C **« Modèle corpusculaire de la lumière »** est publiée en neuf niveaux et 127 questions : effet photoélectrique, photon et relation de Planck-Einstein, quantification, spectres atomiques, niveaux de l'hydrogène, évaluation du sodium à 589 nm, capture électronique, excitation/ionisation et série de Balmer. Trois schémas SVG originaux, trois courbes interactives, une carte de concepts et deux démarches guidées remplacent les figures du PDF. Les puissances de dix, la constante 13,6 eV, la raie Hα à 656 nm, la formule dimensionnelle de Balmer et les explications des couleurs sont corrigées. Le parcours, propre à la Terminale C, distribue exactement 10 000 XP.
- La leçon 18 de Physique en Terminale C / leçon 14 en Terminale D **« Réactions nucléaires spontanées »** est publiée en neuf niveaux et 127 questions : expérience de Rutherford, noyau et isotopes, émissions α/β⁺/β⁻/γ, lois de conservation, loi exponentielle, demi-vie, activité, datation et mission complète sur le polonium 210. Deux schémas SVG originaux, deux cartes, deux démarches guidées et trois courbes interactives remplacent les figures du PDF. Les neutrinos sont rétablis, la constante d’intégration est corrigée, la demi-vie de l’uranium 235 est rectifiée et toutes les mentions erronées de Po-107 sont remplacées par Po-210/Pb-206 ; la mission conduit à Q≈5,40 MeV, λ≈4,998×10⁻³ j⁻¹ et T≈138,7 j. Le parcours commun distribue exactement 10 000 XP.
- La leçon 19 de Physique en Terminale C / leçon 15 en Terminale D **« Réactions nucléaires provoquées »** est publiée en neuf niveaux et 127 questions : défaut de masse, énergie de liaison, fission et réaction en chaîne, fusion et transmutation, bilan énergétique, exercices officiels sur l’iode, le carbone et les surgénérateurs, radioprotection puis mission complète sur l’uranium 235. Deux schémas SVG originaux, deux cartes, trois démarches guidées et deux courbes interactives remplacent les figures du PDF. Les confusions fission/fusion, les bilans de charge fautifs (Y-94 et x=39), le signe des énergies libérées, les équations bêta et le calcul énergétique final sont corrigés et expliqués. Le parcours commun distribue exactement 10 000 XP.
