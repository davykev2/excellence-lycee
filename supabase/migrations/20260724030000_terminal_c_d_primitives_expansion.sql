-- Enrichit la leçon 06 « Primitives » de Terminale C et la leçon 04
-- homologue de Terminale D. Les six identifiants historiques sont conservés ;
-- sept niveaux supplémentaires couvrent la famille, la mission du car et tous
-- les exercices officiels d’application, de renforcement et d’approfondissement.

create temporary table terminal_c_d_primitives_manifest (
  path_id text primary key,
  lesson_ids jsonb not null
) on commit drop;

insert into terminal_c_d_primitives_manifest (path_id, lesson_ids) values
  (
    'terminale-c-math-l06-primitives',
    '["primitive-definition","primitive-existence","primitive-family","primitive-initial-value","usual-primitives","primitive-linearity","composite-primitives","bus-cost-mission","official-applications-workshop","radical-coefficients-reinforcement","derivative-links-reinforcement","composite-reinforcement-workshop","advanced-primitives-mission"]'
  ),
  (
    'terminale-d-math-l04-primitives',
    '["primitive-definition","primitive-existence","primitive-family","primitive-initial-value","usual-primitives","primitive-linearity","composite-primitives","bus-cost-mission","official-applications-workshop","radical-coefficients-reinforcement","derivative-links-reinforcement","composite-reinforcement-workshop","advanced-primitives-mission"]'
  );
...
with raw_rewards as (
  ...
  from terminal_c_d_primitives_manifest as manifest
...
using terminal_c_d_primitives_manifest as manifest
...
with reward_weights as (
  ...
  join terminal_c_d_primitives_manifest as manifest using (path_id)
),
base_allocations as (
  select
    path_id,
...
-- nouveau barème des deux parcours homologues.
...
from public.lesson_rewards as reward
join terminal_c_d_primitives_manifest as manifest
