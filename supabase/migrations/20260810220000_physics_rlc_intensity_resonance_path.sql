-- Publie la leçon de Physique « Résonance d’intensité d’un circuit RLC série »
-- (leçon 14 en Terminale C et leçon 12 en Terminale D, thème Électricité).
--
...
create temporary table rlc_intensity_resonance_manifest (
  path_id text primary key,
  lesson_ids jsonb not null
) on commit drop;

insert into rlc_intensity_resonance_manifest (path_id, lesson_ids) values
  ('terminale-cd-rlc-intensity-resonance', '["resonance-experimental-curve","resonance-frequency-condition","resonance-bandwidth-three-db","resonance-quality-selectivity","resonance-overvoltage-applications","resonance-official-evaluation-audit","resonance-official-exercises-one-three","resonance-characterization-lab-mission","resonance-oscilloscope-radio-mission"]');
...
with raw_rewards as (
  ...
  from rlc_intensity_resonance_manifest as manifest
...
with reward_weights as (
  ...
  join rlc_intensity_resonance_manifest as manifest using (path_id)
),
base_allocations as (
  select
    path_id,
