...
-- « Réactions nucléaires spontanées » (leçon 18 en TC, leçon 14 en TD).
--
...
create temporary table spontaneous_nuclear_manifest (
  path_id text primary key,
  lesson_ids jsonb not null
) on commit drop;

insert into spontaneous_nuclear_manifest (path_id, lesson_ids) values
  ('terminale-cd-spontaneous-nuclear', '["spontaneous-nuclear-rutherford-structure","spontaneous-nuclear-nuclides-isotopes-unit","spontaneous-nuclear-emissions","spontaneous-nuclear-conservation-alpha","spontaneous-nuclear-beta-gamma-application","spontaneous-nuclear-decay-law","spontaneous-nuclear-half-life-curve","spontaneous-nuclear-activity-dating","spontaneous-nuclear-polonium-mission"]');
...
with raw_rewards as (
  ...
  from spontaneous_nuclear_manifest as manifest
...
with reward_weights as (
  ...
  join spontaneous_nuclear_manifest as manifest using (path_id)
),
base_allocations as (
  select
    path_id,
