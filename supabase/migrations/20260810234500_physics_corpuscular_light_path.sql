-- Publie la leçon 17 de Physique en Terminale C :
...
create temporary table corpuscular_light_manifest (
  path_id text primary key,
  lesson_ids jsonb not null
) on commit drop;

insert into corpuscular_light_manifest (path_id, lesson_ids) values
  ('terminale-c-corpuscular-light', '["corpuscular-light-photoelectric-photons","corpuscular-light-planck-einstein","corpuscular-light-quantized-transitions-spectra","corpuscular-light-hydrogen-levels-ionization","corpuscular-light-sodium-evaluation","corpuscular-light-capture-concepts","corpuscular-light-hydrogen-transition-lab","corpuscular-light-absorption-thresholds","corpuscular-light-balmer-mission"]');
...
with raw_rewards as (
  ...
  from corpuscular_light_manifest as manifest
...
with reward_weights as (
  ...
  join corpuscular_light_manifest as manifest using (path_id)
),
base_allocations as (
  select
    path_id,
